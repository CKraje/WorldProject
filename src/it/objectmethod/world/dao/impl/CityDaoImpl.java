...
public class CityDaoImpl implements CityDao {
	...
	private final String SQL_GET_ALL_CITIES="SELECT Name,Population FROM city ci ORDER BY Name ASC";
	...
	private final String SQL_GET_CITIES_BY_NAME="SELECT Name,Population,ID,CountryCode,District"
			+ " FROM city ci WHERE Name LIKE ?";
	...
	private final String SQL_UPDATE_CITY= "UPDATE city ci SET Name=?,CountryCode=?,District=?"
			+ ",Population=? WHERE ID=?";
	private final String SQL_GET_CITY_BY_ID="SELECT * FROM city ci WHERE ID=?";
	...
	public City getCityById(int id) {
		return jdbcTemplateCitydao.queryForObject(SQL_GET_CITY_BY_ID, 
